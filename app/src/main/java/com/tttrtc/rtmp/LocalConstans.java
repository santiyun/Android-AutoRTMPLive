...
public class LocalConstans {
    ...
    public static final int CALL_BACK_ON_ROOM_IJK_ERROR = 23;
    public static final int CALL_BACK_ON_ROOM_IJK_SUCCESS = 24;
    public static final int CALL_BACK_ON_ROOM_VIDEO_ENABLE = 25;
    public static final int CALL_BACK_ON_ROOM_IJK_COMPLETION = 26;
    public static final int CALL_BACK_ON_ROOM_IJK_STATUS = 27;
}